...
public class main extends AppCompatActivity {
    ...
    public Object[] showInputDialog(final Context context, String title, String description, String default_input) {
        if(perform_action) {
            ...
            container_layout.addView(layout, RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
            scroll_view_layout.addView(container_layout, ScrollView.LayoutParams.WRAP_CONTENT, ScrollView.LayoutParams.WRAP_CONTENT);
    ...
    private void showFragmentEx(Context context, Fragment fragment, int visibility) {
        ((AppCompatActivity) context).findViewById(R.id.background_fade).setVisibility(visibility);
    ...
    private void showFragment(Fragment fragment, int visibility) {
        findViewById(R.id.background_fade).setVisibility(visibility);
